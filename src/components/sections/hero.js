...
const Hero = () => {
  ...
  const two = <h2 className="big-heading"><a>Samitha Vidhanaarachchi</a></h2>;
  const three = (
  ...
  const five = (
    ...
    <a className="email-link" href="https://www.sliit.lk/faculty-of-computing/staff/samitha.v/" target="_blank" rel="noreferrer" style={{left: '20px'}}>
      SLIIT Profile
    </a>
    </div>
